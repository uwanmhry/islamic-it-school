...
//${book.linkid}
    ...
    const orderButtonsHtml = `
        <div class="mt-4 flex flex-col gap-3">
            ${book.linkid ? `
                <a href="https://gsiofficial.xyz/gsiofficial/67ejrz6xdwgp" target="_blank" class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg transition duration-200 flex items-center justify-center">
